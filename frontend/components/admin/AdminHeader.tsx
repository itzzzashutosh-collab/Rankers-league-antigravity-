...
import { Search, Bell, Shield, User, Sun, Moon } from "lucide-react";
      ...
      <div className="flex items-center gap-3">
        ...
        {mounted && (
          <Button
            ...
            className="w-9 h-9 rounded-xl border border-border/40 bg-background/50 hover:bg-card flex items-center justify-center text-muted-foreground hover:text-foreground transition-all"
