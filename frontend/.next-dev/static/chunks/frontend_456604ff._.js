...
function LoginPageContent() {
    ...
    const [error, setError] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"](errorParam || "");
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            if (data.user) {
                ...
                if (!(profile === null || profile === void 0 ? void 0 : profile.username) || profile.profile_status !== "complete") {
    ...
    const handleGoogleSignIn = async ()=>{
        ...
        try {
            const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$utils$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createClient"])();
            const callbackUrl = "".concat(window.location.origin, "/auth/callback").concat(redirect && redirect !== "/" ? "?next=".concat(encodeURIComponent(redirect)) : "");
...
_s(LoginPageContent, "lDRH6Y0yH8mSadUQ8tqdZJmjRco=", false, function() {
    return [
...
//# sourceMappingURL=frontend_456604ff._.js.map