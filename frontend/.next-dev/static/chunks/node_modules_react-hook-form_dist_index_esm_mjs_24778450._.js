...
function deepEqual(object1, object2) {
    let visited = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : new WeakMap();
    if (object1 === object2) {
        return true;
    }
 ...
 */ const FormProvider = (param)=>{
    let { children, watch, getValues, getFieldState, setError, clearErrors, setValue, setValues, trigger, formState, resetField, reset, handleSubmit, unregister, control, register, setFocus, subscribe } = param;
...
function createFormControl() {
    ...
    const setFieldValue = function(name, value1) {
        let options = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}, skipClone = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : false, skipRender = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : false;
        const field = get(_fields, name);
    ...
    const setFieldValues = function(name, value1, options) {
        let skipClone = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : false, skipRender = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : false;
    ...
    const _setValue = function(name, value1, options, skipClone) {
        let skipStateEmit = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : false;
        const field = get(_fields, name);
    ...
    const setValue = function(name, value1) {
        ...
        return _setValue(name, value1, options, false);
    };
    const setValues = function(formValues) {
    ...
    const resetDefaultValues = function(values) {
        let options = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
