module.exports = [
"[project]/frontend/.next-internal/server/app/auth/callback/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/frontend/app/auth/callback/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    if (error) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(`${origin}/auth/login?error=${encodeURIComponent(msg)}`);
    }
    if (code) {
        ...
        if (!exchangeError) {
            ...
            if (user) {
                ...
                const { data: profile, error: profileError } = await supabase.from("profiles").select("profile_status, username, full_name, avatar_url").eq("id", user.id).single();
                ...
                if (profileError && profileError.code === "PGRST116") {
                    ...
                    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(`${origin}/auth/complete-profile`);
                }
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(`${origin}/auth/login?error=${encodeURIComponent(errMsg)}`);
    }
    // No code provided
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(`${origin}/auth/login?error=${encodeURIComponent("No auth code received")}`);
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__1761e799._.js.map