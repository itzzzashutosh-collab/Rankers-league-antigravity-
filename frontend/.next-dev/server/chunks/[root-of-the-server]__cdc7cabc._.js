module.exports = [
"[project]/frontend/.next-internal/server/app/api/auth/wallet/deposit/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/frontend/app/api/auth/wallet/deposit/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const refNo = `TXN-DEP-${__TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["default"].randomBytes(4).toString("hex").toUpperCase()}`;
        // Insert manually into wallet_transactions to trigger deduction / addition trigger.
        const { data: txn, error } = await supabase.from("wallet_transactions").insert({
            ...
            description: `Wallet Deposit via ${method.toUpperCase()}`
        }).select("id").single();
        if (error || !txn) {
            throw new Error(error?.message || "Failed to log deposit transaction.");
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            reference: refNo
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cdc7cabc._.js.map